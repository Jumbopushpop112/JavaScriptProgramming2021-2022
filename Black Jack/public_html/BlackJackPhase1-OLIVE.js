...
function dealCards(){  
        ...
        if(player.playersSum > 21){
            alert("Dealer wins because player went over 21!"); 
        }
        if(player.playersSum < 21){
            alert("Sum is less than 21. Hit or stay.");
        }
...
function displayScore(){
    ...
    if (player.playersSum > 21){ 
        alert("Player went over 21. Dealer wins!");
        playAgain();
    }
    if(player.playersSum < 21){
        alert("Hit or stay because your sum is less than 21.");
    }
}
function stay(){ 
        const myDealerElement = document.getElementById("dealersHand");
        ...
        if(dealer.dealersSum > 21){
            alert("Bust! Dealer went over 21!");
            playAgain();
        }
        if(player.playersSum < 21){
            alert("Hit again! Your sum is stil less than 21.");
        }  
...
//    if(dealer.arrayDealersCards.length > 2){
//         newDealerCard = document.createElement("INPUT");
//         var newDealerCardValue = parseInt(Math.random()*11) + 1; 
//         newDealerCard.setAttribute("class","txtBox");      
//         newDealerCard.setAttribute("type","text");
//         document.getElementById("dealersHand").append(newDealerCard);  
//         newDealerCard.value = newDealerCardValue; 
//         newDealerCard.id = "newDealerCard";
//         dealer.arrayDealersCards.push(newDealerCard.value);
//         dealer.dealersSum += newDealerCardValue;   
//    }
//    if(player.playersSum > 21){
//        alert("Player went over 21. Dealer wins at: " + dealer.dealersSum);
//        document.getElementById("txtDealersScore").value = dealer.totalDealerWins + 1;      
//    } 
//    if(player.playersSum < 21){     
//        alert("Your sum is less than 21. Hit or stay."); 
//    }   
